...
<ol>
<li><a href="#1-objetivo-general-del-desarrollo">Objetivo general del desarrollo</a></li>
<li><a href="#2-detalles-inherentes-a-la-landing-page">Detalles inherentes a la Landing Page</a>
<ul>
...
<li><a href="#3-detalles-inherentes-al-saas">Detalles inherentes al SaaS</a>
<ul>
...
<li><a href="#4-detalles-inherentes-a-la-app-nativa">Detalles inherentes a la App nativa</a>
<ul>
...
<li><a href="#conformidad-normativa-en-tiendas-de-aplicaciones-ota-compliance">Conformidad Normativa en Tiendas de Aplicaciones</a></li>
...
<li><a href="#5-especificaciones-funcionales-detalladas-y-l%C3%B3gica-de-implementaci%C3%B3n">Especificaciones Funcionales Detalladas</a>
<ul>
<li><a href="#inventario-de-funciones-analizadas-referencia">INVENTARIO DE FUNCIONES ANALIZADAS</a></li>
</ul>
</li>
<li><a href="#6-bloque-1-estrategia-de-negocio-y-monetizaci%C3%B3n-saas-core">BLOQUE 1: ESTRATEGIA DE NEGOCIO Y MONETIZACIÓN</a>
<ul>
<li><a href="#pasarela-de-cobro-saas-motor-de-retenci%C3%B3n-y-facturaci%C3%B3n-consolidada-banco-plaza-c2p">Pasarela de Cobro SaaS y Facturación</a>
<ul>
...
<ul>
<li><a href="#a-el-administrador-independiente-retail">A) El Administrador Independiente</a></li>
<li><a href="#b-la-comunidad-autogestionada-single-tenant">B) La Comunidad Autogestionada</a></li>
...
<li><a href="#7-bloque-2-el-n%C3%BAcleo-financiero-y-contable-fintech-engine">BLOQUE 2: EL NÚCLEO FINANCIERO Y CONTABLE</a>
<ul>
...
<li><a href="#8-bloque-3-administraci%C3%B3n-cobranza-y-legal-back-office">BLOQUE 3: ADMINISTRACIÓN, COBRANZA Y LEGAL</a>
<ul>
<li><a href="#motor-de-emisi%C3%B3n-masiva-y-gateway-de-comunicaciones-automatizado-omnicanalidad-whatsapp-email--push">Motor de Emisión Masiva y Omnicanalidad</a></li>
<li><a href="#motor-de-gesti%C3%B3n-de-morosidad-configurable-y-cobranza-asistida-rules-engine-kanban--approval-workflow">Motor de Gestión de Morosidad</a></li>
<li><a href="#kiosco-de-autoservicio-legal-y-validaci%C3%B3n-documental-legaltech">Kiosco de Autoservicio Legal</a></li>
</ul>
</li>
<li><a href="#9-bloque-4-operaciones-f%C3%ADsicas-seguridad-y-staff-facility-management">BLOQUE 4: OPERACIONES FÍSICAS, SEGURIDAD Y STAFF</a>
<ul>
...
<li><a href="#10-bloque-5-gobernanza-comunidad-y-proveedores-social--srm">BLOQUE 5: GOBERNANZA, COMUNIDAD Y PROVEEDORES</a>
<ul>
...
<li><a href="#motor-de-carta-consulta-digital-procedimiento-art-23-lph">Motor de Carta Consulta Digital</a></li>
...
<li><a href="#inteligencia-de-negocios-360%C2%B0-benchmarking-anal%C3%ADtica-prescriptiva-y-portal-de-transparencia-bi--data-storytelling">Inteligencia de Negocios 360°</a></li>
...
<li><a href="#11-esquemas">ESQUEMAS</a>
<ul>
...
<li><a href="#13-documentaci%C3%B3n-t%C3%A9cnica-externa">Documentación Técnica Externa</a>
<ul>
<li><a href="./ERD_DATABASE.md">Modelo de Base de Datos (ERD)</a></li>
<li><a href="./DICCIONARIO_DATOS.md">Diccionario de Datos</a></li>
</ul>
</li>
<li><a href="./Flujos/">Flujos Lógicos (Detalle)</a>
<ul>
<li><a href="./Flujos/01_CORE_PLATAFORMA.md">01 Core Plataforma</a></li>
<li><a href="./Flujos/02_FINANZAS_CONTABILIDAD.md">02 Finanzas y Contabilidad</a></li>
<li><a href="./Flujos/03_ADMIN_COBRANZA.md">03 Admin y Cobranza</a></li>
